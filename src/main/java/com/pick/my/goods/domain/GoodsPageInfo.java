...
public class GoodsPageInfo {
	...
	public GoodsPageInfo(int currentPage, int boardLimit, int naviLimit, int startNavi, int endNavi, int totalCount,
			int maxPage) {
		super();
	...
	public String toString() {
		return "GoodsPageInfo [currentPage=" + currentPage + ", boardLimit=" + boardLimit + ", naviLimit=" + naviLimit
				+ ", startNavi=" + startNavi + ", endNavi=" + endNavi + ", totalCount=" + totalCount + ", maxPage="
				+ maxPage + ", goodsName=" + goodsName + ", groupName=" + groupName + ", idolName=" + idolName + "]";
	}
}
